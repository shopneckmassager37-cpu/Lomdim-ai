...
import { CheckCircle, XCircle, Clock, ArrowRight, BrainCircuit, Sparkles, Target, TrendingUp, TrendingDown, Loader2, FileText, ChevronLeft } from 'lucide-react';
...
const HistoryView: React.FC<HistoryViewProps> = ({ history, onBack, onOpenSummary }) => {
  ...
  const mostCommonSubject = Object.entries(subjectCounts).sort((a, b) => (b[1] as number) - (a[1] as number))[0]?.[0] || '-';
