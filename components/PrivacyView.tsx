      ...
      <div className="bg-white rounded-[3rem] shadow-xl border border-gray-100 overflow-hidden">
        <div className="bg-gray-900 p-10 md:p-16 text-center text-white relative">
            ...
            <div className="relative z-10">
                ...
                <h1 className="text-3xl md:text-4xl font-black mb-4">מדיניות פרטיות – Lomdim</h1>
        ...
        <div className="p-8 md:p-16 space-y-12">
            <section className="prose prose-blue max-w-none text-right" dir="rtl">
                <p className="text-lg text-gray-700 leading-relaxed mb-12">
                    ברוכים הבאים ל-Lomdim. הפרטיות שלכם חשובה לנו מאוד. מדיניות זו מסבירה כיצד אנו אוספים, משתמשים ושומרים על המידע שלכם בעת השימוש באתר או באפליקציה שלנו.
                </p>
